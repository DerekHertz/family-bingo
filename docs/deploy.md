# Deploying Family Bingo

Everything below is the operational half of the project — standing up a Supabase project,
the CI/CD pipeline, the public demo, and running a build on a phone. The
[README](../README.md) is the introduction; this is the runbook.
...
There is no published build in any app store — this is how to run one locally or hand one
to a tester, not how to ship to a store.
